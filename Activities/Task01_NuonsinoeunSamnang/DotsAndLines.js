...
var VSHADER_SOURCE =
  `attribute vec4 a_Position;
   void main() {
     ...
     gl_PointSize = 16.0;				// point-size in pixels (for point primitive)
   }`
...
var FSHADER_SOURCE =
 `void main() {
    gl_FragColor = vec4(0.0, 0.0, 1.0, 1.0); // easy! every pixel has this color
  }`
...
//==============================================================================
  ...
  gl.clearColor(1.0, 1.0, 1.0 , 1.0);	// R,G,B,A (A==opacity)
  // NOTE: 0.0 <= RGBA <= 1.0 
  // others to try:
